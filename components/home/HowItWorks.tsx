...

{
    ...
    label: 'AI Analysis',
    description: 'Our Advanced AI process and analyzes your document instantly'
},
    ...
    return (
        <section className="relative overflow-hidden bg-gray-50">
            ...
            <div className="text-center mb-16 ">
                    <h2 className="text-xl font-bold uppercase mb-4 text-rose-500">How it works</h2>
                    <h3 className="font-bold text-3xl max-w-2xl mx-auto">Transform any PDF into an easy-to-digist summary in three simple steps</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto relative">
                    {
                        steps.map((step, idx) => (
                            ...
                            <div className="relative flex items-stretch" key = {idx}>
                                ...
                                {idx < steps.length -1 && (
                                    <div className="hidden md:block absolute top-1/2 -right-4 transform -translate-y-1/2 z-50">
